...
assignment/exercises-0x/exercise-6/exercise_06b_opening_closing.sh "$@" "$EXERCISE_OUT-01.pgm"
assignment/exercises-0x/exercise-6/exercise_06b_opening_closing.sh "$1" "$EXERCISE_OUT-01.pgm" "$EXERCISE_OUT-02.pgm"
